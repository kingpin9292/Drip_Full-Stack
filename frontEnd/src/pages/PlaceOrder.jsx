...
const PlaceOrder = () => {
  ...
  const { navigate, products, cartItems, backEndUrl, getCartAmount, token, setCartItems, delivery_fee } =
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border border-gray-400 rounded-full ${method === "stripe" ? "bg-green-400" : ""}`}
              ></p>
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border border-gray-400 rounded-full ${method === "razorpay" ? "bg-green-400" : ""}`}
              ></p>
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border border-gray-400 rounded-full ${method === "cod" ? "bg-green-400" : ""}`}
              ></p>
